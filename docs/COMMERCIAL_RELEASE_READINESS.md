...
| Billing | Published prices and server-side entitlements agree | Ready for manual pilots | Paid activation requires explicit payment confirmation; complimentary access requires an expiration and reason |
