...
const columns = [
  ...
  ["Duration (Optional)", "Programme duration. Required on the final row.", "HH:MM:SS", "00:30:00", "Conditional"],
  ["Parental Rating", "TV or movie content rating.", "Dropdown / Text", "TV-PG", "Required"],
  ["Program Description", "Programme-level synopsis; fallback when episode description is blank.", "Text", "Daily morning news.", "Conditional"],
  ["Original Title", "Title in the original language.", "Text", "Noticias Matutinas", "Optional"],
  ["Cast", "Cast names separated by semicolons.", "Text", "Jane Doe; John Smith", "Optional"],
  ["Season Number", "Season number for episodic content.", "Whole number", "1", "Optional"],
  ["Episode Number", "Episode number for episodic content.", "Whole number", "1", "Optional"],
  ["Original Episode Title", "Episode title.", "Text", "Opening Edition", "Optional"],
  ["Episode Description", "Episode synopsis; preferred XMLTV description.", "Text", "The day's top stories.", "Conditional"],
  ["Genre", "Genre or category.", "Text", "News", "Required"],
  ["Country of Production", "Country where the content was produced.", "Text", "United States", "Optional"],
  ["Production Year", "Production year for internal metadata.", "YYYY", "2026", "Optional"],
  ["Premiere", "Indicates a premiere.", "Yes / No", "Yes", "Optional"],
  ["Live", "Indicates this specific airing is live.", "Yes / No", "Yes", "Optional"],
  ["New", "Indicates a new episode or programme.", "Yes / No", "Yes", "Optional"],
  ["Asset ID", "Unique video asset identifier.", "Text", "morning-news-s01e01", "Required"],
  ["Original Air Date", "Original release or air date.", "Date: YYYY-MM-DD", "2026-07-18", "Optional"],
  ...
  ["Previously Shown", "Indicates a repeat or previously aired programme.", "Yes / No", "No", "Optional"],
];
...
const steps = [
  ...
  [3, "Complete all required fields: Air Date, Start Time, Program Title, Description, Genre, Parental Rating, and Asset ID."],
  [4, "Enter either Episode Description or Program Description. Episode Description takes priority in XMLTV."],
  [5, "Use a unique and stable Asset ID for every video asset."],
